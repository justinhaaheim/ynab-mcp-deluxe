...
/**
 * Check if backup on start is disabled
 * Backup is enabled by default, set YNAB_BACKUP_ON_START=false to disable
 */
export function isBackupOnStartDisabled(): boolean {
  const value = process.env['YNAB_BACKUP_ON_START'];
